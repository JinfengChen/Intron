...
def basecomposition_win(fastafile):
    win = 50
    ...
    ofile = open('exon.basecomp.distr', 'w')
    base_frq = []
    for i in sorted(five_prim_avg.keys()):
...
def main():
    ...
    basecomposition_win('../input/Os.exon.fa')
