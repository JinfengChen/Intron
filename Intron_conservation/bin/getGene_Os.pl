...
##Chr1    MSU_osa1r7      exon    2903    3268    .       +       .       ID=LOC_Os01g01010.1:exon_1;Parent=LOC_Os01g01010.1
                        #Chr1    MSU_osa1r7      mRNA    2903    10817   .       +       .       ID=LOC_Os01g01010.1;Name=TBC domain containing protein,expressed;
                        #Chr1    MSU_osa1r7      CDS     3449    3616    .       +       .       Parent=LOC_Os01g01010.1

                        $qname = $1 if($t[8] =~ /ID=(.*?);/);
                        #print "mRNA: $t[2]\t$qname\n";
		}
                if ($t[2] eq 'CDS') {
                        #$qname = $1 if($t[8] =~ /ID=(.*?)\:.*?;/);
